...
const resourceLinks = [
  ...
  { label: "Flag Editor", href: "#" },
  { label: "Validator", href: "#" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-xl font-bold gradient-text">Robify</span>
            </Link>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              The ultimate Roblox Fast Flags library. Free, open source, and community driven.
            </p>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Robify. Open source under MIT License.
          </p>
          <p className="text-xs text-muted-foreground">
